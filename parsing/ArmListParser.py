...
class ArmListParser:
            ...
            if timestamp in full_matrix:
                if event['type'] == 'chord':
                    ...
                    interpolated_values_2 = [
                        #ArmListParser.interp_with_blend(curr_pos[i + 6], -100, num_points, tb_cent) PRESSER_CHANGE
                        ArmListParser.interp_with_blend(-50, -50, num_points, tb_cent)
                    ...
                    interpolated_values_4 = [
                        ArmListParser.interp_with_blend(-50, -50, num_points, tb_cent)  # Change to fill later
                        for i in range(len(target_positions_presser))
                    ]
                    ...
                    interpolated_values_6 = [
                        ArmListParser.interp_with_blend(-250, target_positions_presser[i], num_points, tb_cent)
                        for i in range(len(target_positions_presser))
                    ]
    ...
    def parseleftMIDI(chords):
        ...
        presser_encoder_values = [-50, 500, 200]
