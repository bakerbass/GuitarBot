...
def main():
    ...
    # LH = []
    strum = [['strum', [45, 75, 0], 0], ['strum', [-45, 75, 0], 3], ['strum', [45, 75, 0], 6], ['strum', [-45, 75, 0], 9]]
    #strum = []
    pick = [['pick', [[1, 1, 1, 2, 1, 1], [120, 10]], 1], ['pick', [[1, 1, 1, 2, 1, 1], [120, 10]], 4], ['pick', [[1, 1, 1, 2, 1, 1], [120, 10]], 7], ['pick', [[1, 1, 1, 2, 1, 1], [120, 10]], 10]]
    # pick = []
    Events = []
    for event in LH:
        Events.append(event)
